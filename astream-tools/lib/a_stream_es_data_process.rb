...
require 'rest-client' 
require 'jsonify'
#product_service_info.rb文件，require的时候下面直接require当前目录下的总是报错，将该文件放在 ../vendor/gen-rb下面
require "../vendor/gen-rb/product_service_info.rb"
...
class A_stream_es_data_process
  #get_es_data函数接受参数，然后分析参数，根据参数查询es
